...
const BridgeBsc = require("../../client/src/components/contract/BscBridge.json");
...
router.post('/eth2bsc', async (req, res) => {
  ...
  console.log(`I will burn ETHFloki(${id}) from ${account}`)
  try {
  ...
  console.log(`I will mint BSCFloki to ${account} with ${uri}`)
  try {
